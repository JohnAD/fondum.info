...
class Config(BaseConfig):
    ...
    # MongoDB details
    #
    MONGODB_DB = 'fondum_fondum_info'
    MONGODB_HOST = 'mongodb://db/fondum_fondum_info'
    #
    # Amazon S3 details
    #
    ...
    S3_BUCKET = 'fondum-fondum_info-article-pictures'  # this is the default bucket for article pictures
    #
    # Google OAuth2 details
    #
    # return urls to authorize in the Google Developer Console:
    #
    #   http://fondum.info.localtest.me/account/google-oauth2-callback/new
    #   http://fondum.info/account/google-oauth2-callback/new
    #   http://fondum.info.localtest.me/account/google-oauth2-callback/current
    #   http://fondum.info/account/google-oauth2-callback/current
    #
    GOOGLE_OAUTH = {
